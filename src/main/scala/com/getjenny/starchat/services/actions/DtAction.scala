...
object DtAction {
  ...
  def apply(indexName: String, stateName: String, action: String, params: Seq[JsObject], data: Map[String, String], query: String): DtActionResult = {
    action match {
...
object DtActionAtomAdapter {
  ...
  def apply(indexName: String, stateName: String, action: String, params: Seq[JsObject], query: String, data: Map[String, String]): DtActionResult = {
